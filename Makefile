...
CS333_UPROGS += _date _p2_test _ps _time _ps_test
...
CS333_UPROGS += _date _time _ps _p2_test _p3_sleep _p3_zomb _p3_killtest _loopforever
CS333_TPROGS += _p3-test #_testsetuid _testuidgid _p2-test _p3-test
endif

ifeq ($(CS333_PROJECT), 4)
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCS333_P3 -DCS333_P4
CS333_UPROGS += _date _time _ps _prio_test _loopforever _budget-test
CS333_TPROGS += _p2-test _p4-test _p4-priority _prio_loop #_testsetuid _testuidgid
endif
